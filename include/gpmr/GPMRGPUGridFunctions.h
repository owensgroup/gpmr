...
__device__ void gpmrGridEmitKeyValRegister(GPMRGPUConfig * const config, const int outputNumber, const Key & key, const Value & value)
{
}

template <typename Key, typename Value>
__device__ void gpmrGridEmitKeyValShared(GPMRGPUConfig * const config,
...
template <typename Key, typename Value>
__device__ void gpmrGridEmitKeyValGlobal(GPMRGPUConfig * const config, const int outputNumber, const Key * const keyDataForBlock, const Value * const valueDataForBlock)
{
  const int * begin;
  const int * end;
  int * output;
